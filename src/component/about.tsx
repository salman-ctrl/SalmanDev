        ...
        <section id='about' className='h-auto -mt-8 '>
            <div className='h-full w-full'>
                <div className='w-full flex justify-center gap-5 items-center pt-40'>
                    ...
                    <h1 data-aos="fade-left" data-aos-delat="500" className='text-center align-middle text-4xl text-sky-300 cursor-pointer hover:shadow-sky-300 hover:shadow-md overflow-hidden px-16 py-3  transition duration-1000 flex hover:scale-105 gap-5'>
                        About Me
                ...
                <div className='w-full h-full pl-16 pt-16 flex gap-8  justify-center mb-10 '>
                    ...
                    <div data-aos="fade-left" data-aos-delay="500" className='px-10 w-1/2 border-2 mr-10 bg-black border-sky-300 hover:border-white  py-10 rounded-lg transition duration-1000 hover:scale-105'>
